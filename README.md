...
*SwaggerUnicast.DegreeApi* | [**findDegreesByName**](docs/DegreeApi.md#findDegreesByName) | **GET** /degrees/search/name | Busca una carrera con un nmbre dado
...
*SwaggerUnicast.DisplayApi* | [**displaysDeleteVideoIdDelete**](docs/DisplayApi.md#displaysDeleteVideoIdDelete) | **DELETE** /displays/delete/{video_id} | Elimina la visualizacion dada
...
*SwaggerUnicast.SubjectApi* | [**findSubjectsByName**](docs/SubjectApi.md#findSubjectsByName) | **GET** /subjects/search/name | Busca una asignatura con un nmbre dado
...
*SwaggerUnicast.UniversityApi* | [**getSubjecstFromUniversity**](docs/UniversityApi.md#getSubjecstFromUniversity) | **GET** /universities/{id}/subjects | Devuelve una lista con las asignaturas de una universidad
...
*SwaggerUnicast.VideoApi* | [**getVideosOfUserSubjects**](docs/VideoApi.md#getVideosOfUserSubjects) | **GET** /videos/search/userSubjects | Lista de videos de una asignatura
...
## Documentation for Models
 ...
 - [SwaggerUnicast.ReproductionListList](docs/ReproductionListList.md)
