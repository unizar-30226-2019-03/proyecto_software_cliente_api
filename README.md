...
*SwaggerUnicast.DegreeApi* | [**findDegreeStartsWith**](docs/DegreeApi.md#findDegreeStartsWith) | **GET** /degrees/search/nameStartsWith | Busca carreras que empiecen por el nombre dado
