...
*SwaggerUnicast.DegreeApi* | [**putDegreeUniversity**](docs/DegreeApi.md#putDegreeUniversity) | **PUT** /degrees/{id}/universities | Relacionar una universidad con una asignatura
