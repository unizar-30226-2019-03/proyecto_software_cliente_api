...
*SwaggerUnicast.DegreeApi* | [**putDegreeUniversity**](docs/DegreeApi.md#putDegreeUniversity) | **PATCH** /degrees/{id}/universities | Relacionar una carrera con una universidad
