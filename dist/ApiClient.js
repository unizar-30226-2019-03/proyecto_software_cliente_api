...
var ApiClient = function () {
    function ApiClient() {
         ...
         * @type {String}
         * @default http://ec2-35-181-26-7.eu-west-3.compute.amazonaws.com:8080/api
         */
        this.basePath = 'http://ec2-35-181-26-7.eu-west-3.compute.amazonaws.com:8080/api'.replace(/\/+$/, '');
        ...
        value: function hostSettings() {
            return [{
                ...
                'variables': {
                    host: {
                        'description': "No description provided",
                        'default_value': "ec2-35-181-26-7.eu-west-3.compute.amazonaws.com"
                    },
                    protocol: {
                        'description': "No description provided",
                        'default_value': "http",
