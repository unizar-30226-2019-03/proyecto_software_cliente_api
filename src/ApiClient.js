...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default http://ec2-35-181-76-150.eu-west-3.compute.amazonaws.com:8080/api
         */
        this.basePath = 'http://ec2-35-181-76-150.eu-west-3.compute.amazonaws.com:8080/api'.replace(/\/+$/, '');
        ...
        return [
            {
              ...
              'variables': {
                host: {
                    'description': "No description provided",
                    'default_value': "ec2-35-181-76-150.eu-west-3.compute.amazonaws.com",
                  },
                protocol: {
                    'description': "No description provided",
                    'default_value': "http",
