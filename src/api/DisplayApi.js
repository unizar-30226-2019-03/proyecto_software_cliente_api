...
export default class DisplayApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the displaysVideoIdDelete operation.
     * @callback module:api/DisplayApi~displaysVideoIdDeleteCallback
     ...
     * @param {module:api/DisplayApi~displaysVideoIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    displaysVideoIdDelete(videoId, callback) {
      let postBody = null;
      // verify the required parameter 'videoId' is set
      if (videoId === undefined || videoId === null) {
        throw new Error("Missing the required parameter 'videoId' when calling displaysVideoIdDelete");
      }
