...
export default class DisplayApi {
    ...
    */
     ...
     * @param {module:model/DisplayGetEmbedded2} data The data returned by the service call.
     ...
     * @param {String} opts.projection Incluir si se quiere obtener tambien los videos en la respuesta (default to 'displayWithVideo')
     ...
     * data is of type: {@link module:model/DisplayGetEmbedded2}
     */
    getDisplaysByUser(id, opts, callback) {
      ...
      let returnType = DisplayGetEmbedded2;
