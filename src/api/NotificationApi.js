...
export default class NotificationApi {
    ...
    */
     ...
     * @param {Number} userId Id del usuario sobre el que comprobar las notificaciones
     ...
     */
    getUserNotifications(userId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getUserNotifications");
      }
     ...
     * data is of type: {@link module:model/UserIsNotifiedGetResponse2}
     */
    getUserUncheckedNotifications(userId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getUserUncheckedNotifications");
      }
