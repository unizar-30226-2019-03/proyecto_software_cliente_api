...
export default class SubjectApi {
    ...
    */
     ...
     * @param {Number} userId Id el usuario a buscar
     ...
     */
    existsUserInSubject(userId, subjectId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling existsUserInSubject");
      }
      // verify the required parameter 'subjectId' is set
      if (subjectId === undefined || subjectId === null) {
     ...
     * @param {Number} id Id de la asignatura
     * @param {Number} body Id del usuario a asociar con la asignatura
