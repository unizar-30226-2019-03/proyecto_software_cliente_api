...
export default class UniversityApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getSubjecstFromUniversity operation.
     * @callback module:api/UniversityApi~getSubjecstFromUniversityCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.pragma  (default to 'no-cache')
     * @param {String} opts.expires  (default to '0')
     * @param {module:api/UniversityApi~getSubjecstFromUniversityCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SubjectGetEmbedded2}
     */
    getSubjecstFromUniversity(id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getSubjecstFromUniversity");
      }
