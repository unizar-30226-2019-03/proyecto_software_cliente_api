...
export default class VideoApi {
    ...
    */
     ...
     * @param {Number} uploaderId Id del uploader
     * @param {Object} opts Optional parameters
     * @param {String} opts.cacheControl  (default to 'no-cache, no-store, must-revalidate')
     * @param {String} opts.pragma  (default to 'no-cache')
     * @param {String} opts.expires  (default to '0')
     ...
     * data is of type: {@link module:model/VideoGetResponse2}
     */
    getVideosFromUploader(uploaderId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'uploaderId' is set
      if (uploaderId === undefined || uploaderId === null) {
        throw new Error("Missing the required parameter 'uploaderId' when calling getVideosFromUploader");
      }
     ...
     * data is of type: {@link module:model/VideoGetResponse2}
     */
    getVideosOfUserSubjects(userId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'userId' is set
      if (userId === undefined || userId === null) {
        throw new Error("Missing the required parameter 'userId' when calling getVideosOfUserSubjects");
      }
