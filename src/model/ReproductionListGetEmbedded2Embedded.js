    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('degrees')) {
                obj['degrees'] = ApiClient.convertToType(data['degrees'], [ReproductionList2]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/ReproductionList2>} degrees
 */
ReproductionListGetEmbedded2Embedded.prototype['degrees'] = undefined;
