    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('reproductionLists')) {
                obj['reproductionLists'] = ApiClient.convertToType(data['reproductionLists'], [ReproductionList]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<module:model/ReproductionList>} reproductionLists
 */
ReproductionListGetEmbeddedEmbedded.prototype['reproductionLists'] = undefined;
