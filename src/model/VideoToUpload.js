...
class VideoToUpload {
     ...
     */
    constructor(file, title, description, subjectId) { 
        
        VideoToUpload.initialize(this, file, title, description, subjectId);
    }
     ...
     */
    static initialize(obj, file, title, description, subjectId) { 
        obj['file'] = file;
        obj['title'] = title;
