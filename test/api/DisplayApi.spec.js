...
(function(root, factory) {
  ...
  describe('DisplayApi', function() {
    describe('displaysVideoIdDelete', function() {
      it('should call displaysVideoIdDelete successfully', function(done) {
        //uncomment below and update the code to test displaysVideoIdDelete
        //instance.displaysVideoIdDelete(function(error) {
