...
(function(root, factory) {
  ...
  describe('DisplayApi', function() {
    describe('deleteDisplay', function() {
      it('should call deleteDisplay successfully', function(done) {
        //uncomment below and update the code to test deleteDisplay
        //instance.deleteDisplay(function(error) {
    ...
    describe('findByUserIdAndVideoId', function() {
      it('should call findByUserIdAndVideoId successfully', function(done) {
        //uncomment below and update the code to test findByUserIdAndVideoId
        //instance.findByUserIdAndVideoId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
