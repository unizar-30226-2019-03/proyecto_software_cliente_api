...
(function(root, factory) {
  ...
  describe('DisplayApi', function() {
    describe('displaysDeleteVideoIdDelete', function() {
      it('should call displaysDeleteVideoIdDelete successfully', function(done) {
        //uncomment below and update the code to test displaysDeleteVideoIdDelete
        //instance.displaysDeleteVideoIdDelete(function(error) {
