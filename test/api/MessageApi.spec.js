...
(function(root, factory) {
  ...
  describe('MessageApi', function() {
    ...
    describe('getMessagesOfSender', function() {
      it('should call getMessagesOfSender successfully', function(done) {
        //uncomment below and update the code to test getMessagesOfSender
        //instance.getMessagesOfSender(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
