...
(function(root, factory) {
  ...
  describe('SubjectApi', function() {
    ...
    describe('deleteUserFromSubject', function() {
      it('should call deleteUserFromSubject successfully', function(done) {
        //uncomment below and update the code to test deleteUserFromSubject
        //instance.deleteUserFromSubject(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
