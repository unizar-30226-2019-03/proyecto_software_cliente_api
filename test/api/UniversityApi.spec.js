...
(function(root, factory) {
  ...
  describe('UniversityApi', function() {
    ...
    describe('findUniversityStartsWith', function() {
      it('should call findUniversityStartsWith successfully', function(done) {
        //uncomment below and update the code to test findUniversityStartsWith
        //instance.findUniversityStartsWith(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
