...
(function(root, factory) {
  ...
  describe('UniversityApi', function() {
    ...
    describe('getSubjecstFromUniversity', function() {
      it('should call getSubjecstFromUniversity successfully', function(done) {
        //uncomment below and update the code to test getSubjecstFromUniversity
        //instance.getSubjecstFromUniversity(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
