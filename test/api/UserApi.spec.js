...
(function(root, factory) {
  ...
  describe('UserApi', function() {
    ...
    describe('getVideosOfUser', function() {
      it('should call getVideosOfUser successfully', function(done) {
        //uncomment below and update the code to test getVideosOfUser
        //instance.getVideosOfUser(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
