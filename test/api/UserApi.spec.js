...
(function(root, factory) {
  ...
  describe('UserApi', function() {
    ...
    describe('eraseProfessor', function() {
      it('should call eraseProfessor successfully', function(done) {
        //uncomment below and update the code to test eraseProfessor
        //instance.eraseProfessor(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('findUserProfessors', function() {
      it('should call findUserProfessors successfully', function(done) {
        //uncomment below and update the code to test findUserProfessors
        //instance.findUserProfessors(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getSubjectsAsProfessor', function() {
      it('should call getSubjectsAsProfessor successfully', function(done) {
        //uncomment below and update the code to test getSubjectsAsProfessor
        //instance.getSubjectsAsProfessor(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('makeProfessor', function() {
      it('should call makeProfessor successfully', function(done) {
        //uncomment below and update the code to test makeProfessor
        //instance.makeProfessor(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
