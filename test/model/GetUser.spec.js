...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerUnicast.GetUser();
  });
  ...
  describe('GetUser', function() {
    it('should create an instance of GetUser', function() {
      // uncomment below and update the code to test GetUser
      //var instane = new SwaggerUnicast.GetUser();
      //expect(instance).to.be.a(SwaggerUnicast.GetUser);
    });
