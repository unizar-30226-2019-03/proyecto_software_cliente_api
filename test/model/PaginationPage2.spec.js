...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerUnicast.PaginationPage2();
  });
  ...
  describe('PaginationPage2', function() {
    it('should create an instance of PaginationPage2', function() {
      // uncomment below and update the code to test PaginationPage2
      //var instane = new SwaggerUnicast.PaginationPage2();
      //expect(instance).to.be.a(SwaggerUnicast.PaginationPage2);
    });
