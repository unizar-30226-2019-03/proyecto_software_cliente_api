...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerUnicast.UniversityLinksLinks();
  });
  ...
  describe('UniversityLinksLinks', function() {
    it('should create an instance of UniversityLinksLinks', function() {
      // uncomment below and update the code to test UniversityLinksLinks
      //var instane = new SwaggerUnicast.UniversityLinksLinks();
      //expect(instance).to.be.a(SwaggerUnicast.UniversityLinksLinks);
    });
