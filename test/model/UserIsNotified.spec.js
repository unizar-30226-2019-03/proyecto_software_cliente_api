...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerUnicast.UserIsNotified();
  });
  ...
  describe('UserIsNotified', function() {
    it('should create an instance of UserIsNotified', function() {
      // uncomment below and update the code to test UserIsNotified
      //var instane = new SwaggerUnicast.UserIsNotified();
      //expect(instance).to.be.a(SwaggerUnicast.UserIsNotified);
    });
